...
function getARandomColor() {
  var colors = [colorToEat, 'blue', colorToEat, 'purple', colorToEat, 'green', colorToEat];
...
function drawBallNumbers(balls) {  
  ...
  if(balls.length === 0){
    ...
    side.innerHTML = "Balls still alive: "+ balls.length
        + "<br>"+ "Good Balls eaten: "+ goodBallsEaten + "<br>" + "Wrong Balls eaten: "+ wrongBallsEaten;
  }
  ctx.restore();
}
...
balls.splice(index,1);  // to remove the touched ball by the player and from the array
}
}
