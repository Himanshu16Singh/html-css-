function computeBirthdays(){
    ...
    //as a string(ex: "2016-10-16")
    //Let's turn it into a Date object
    var birthdayAsDate = new Date(birthday);

    //Get the month and date (ex: November 16)
    var birthdayMonth = birthdayAsDate.getMonth();  //ex: November
    ...
    {
        var dayOfTheWeekMyBirthDayOccurs = new Date(year, birthdayMonth, birthdayDate).getDay();

        console.log('Year : ' + year + " Day of your birthday: "+ getDayName(dayOfTheWeekMyBirthDayOccurs));
